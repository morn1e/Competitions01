...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'isAdmin' => \Laravel\Http\Middleware\IsAdminMiddleware::class,
        'isArbiter' => \Laravel\Http\Middleware\IsArbiterMiddleware::class,
        'isParticipant' => \Laravel\Http\Middleware\IsParticipantMiddleware::class,
